...
__all__ = ['ENetFusionBAM']
class ENetFusionBAM(nn.Module):
    def __init__(self, args):
        super(ENetFusionBAM, self).__init__()
        self.args = args
        ...
        self.FusionLayer1 = FusionBAMBlock(channel=64)
        ...
        self.FusionLayer2 = FusionBAMBlock(channel=128)
        ...
        self.FusionLayer3 = FusionBAMBlock(channel=256)
        ...
        self.FusionLayer4 = FusionBAMBlock(channel=512)
    ...
    def forward(self, input):
        ...
        # b 1 352 1216
        rgb_feature = self.rgb_conv_init(torch.cat((rgb, d), dim=1)) # 32
        rgb_feature1 = self.rgb_encoder_layer1(rgb_feature, geo_s1, geo_s2) # b 64 176 608
        rgb_feature2 = self.rgb_encoder_layer2(rgb_feature1, geo_s2, geo_s2) # b 64 176 608
        rgb_feature3 = self.rgb_encoder_layer3(rgb_feature2, geo_s2, geo_s3) # b 128 88 304
        rgb_feature4 = self.rgb_encoder_layer4(rgb_feature3, geo_s3, geo_s3) # b 128 88 304
        rgb_feature5 = self.rgb_encoder_layer5(rgb_feature4, geo_s3, geo_s4) # b 256 44 152
        rgb_feature6 = self.rgb_encoder_layer6(rgb_feature5, geo_s4, geo_s4) # b 256 44 152
        rgb_feature7 = self.rgb_encoder_layer7(rgb_feature6, geo_s4, geo_s5) # b 512 22 76
        rgb_feature8 = self.rgb_encoder_layer8(rgb_feature7, geo_s5, geo_s5) # b 512 22 76
        rgb_feature9 = self.rgb_encoder_layer9(rgb_feature8, geo_s5, geo_s6) # b 1024 11 38
        rgb_feature10 = self.rgb_encoder_layer10(rgb_feature9, geo_s6, geo_s6) # b 1024 11 38
        ...
        rgb_depth = self.rgb_decoder_output(rgb_feature0_plus)
        ...
        sparsed_feature1 = self.depth_layer1(sparsed_feature, geo_s1, geo_s2)# b 64 176 608
        sparsed_feature2 = self.depth_layer2(sparsed_feature1, geo_s2, geo_s2) # b 64 176 608

        # sparsed_feature2_plus = torch.cat([rgb_feature2_plus, sparsed_feature2], 1)
        sparsed_feature2_plus = self.FusionLayer1(sparsed_feature2, rgb_feature2_plus)
        sparsed_feature3 = self.depth_layer3(sparsed_feature2_plus, geo_s2, geo_s3) # b 128 88 304
        sparsed_feature4 = self.depth_layer4(sparsed_feature3, geo_s3, geo_s3) # b 128 88 304

        # sparsed_feature4_plus = torch.cat([rgb_feature4_plus, sparsed_feature4], 1)
        sparsed_feature4_plus = self.FusionLayer1(sparsed_feature4, rgb_feature4_plus)
        sparsed_feature5 = self.depth_layer5(sparsed_feature4_plus, geo_s3, geo_s4) # b 256 44 152
        sparsed_feature6 = self.depth_layer6(sparsed_feature5, geo_s4, geo_s4) # b 256 44 152

        # sparsed_feature6_plus = torch.cat([rgb_feature6_plus, sparsed_feature6], 1)
        sparsed_feature6_plus = self.FusionLayer1(sparsed_feature6, rgb_feature6_plus)
        sparsed_feature7 = self.depth_layer7(sparsed_feature6_plus, geo_s4, geo_s5) # b 512 22 76
        sparsed_feature8 = self.depth_layer8(sparsed_feature7, geo_s5, geo_s5) # b 512 22 76

        # sparsed_feature8_plus = torch.cat([rgb_feature8_plus, sparsed_feature8], 1)
        sparsed_feature8_plus = self.FusionLayer1(sparsed_feature8, rgb_feature8_plus)
        sparsed_feature9 = self.depth_layer9(sparsed_feature8_plus, geo_s5, geo_s6) # b 1024 11 38
        sparsed_feature10 = self.depth_layer10(sparsed_feature9, geo_s6, geo_s6) # b 1024 11 38
        ...
        depth_depth = self.decoder_layer6(decoder_feature5)

        ## 残差结构
        output = rgb_depth + depth_depth

        if(self.args.network_model == 'e'):
            return rgb_depth, output
